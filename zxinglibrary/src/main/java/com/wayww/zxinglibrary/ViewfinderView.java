...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    focusAnimator = new ValueAnimator();
    startFocusAnimation();
  }
  ...
  public void onDraw(Canvas canvas) {
    ...
    float offset = focusValue*frame.width()/20;

    canvas.drawRect(0, 0, width, frame.top+offset, paint);
    canvas.drawRect(0, frame.top+offset, frame.left+offset, frame.bottom -offset, paint);
    canvas.drawRect(frame.right -offset, frame.top+offset, width, frame.bottom -offset, paint);
    canvas.drawRect(0, frame.bottom -offset, width, height, paint);

//    paint.setStyle(Paint.Style.STROKE);
//    paint.setStrokeWidth(16);
//    paint.setColor(maskColor);
//    canvas.drawRect(frame.left+offset,frame.top+offset,frame.right-offset,frame.bottom-offset,paint);
  ...
  public void startFocusAnimation(){
    if (focusAnimator.isRunning())
      return;
    focusAnimator = ValueAnimator.ofFloat(0F,1F,0.8F,1f,0f);
    focusAnimator.setDuration(1000);
    focusAnimator.setStartDelay(3000);
    focusAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
      @Override
      public void onAnimationUpdate(ValueAnimator valueAnimator) {
        focusValue = (float) valueAnimator.getAnimatedValue();
     //   invalidate(frame);
